// Kept out of composables.ts on purpose: settingsStore imports that file for useWindowSize, so a
// store import there closes a cycle back through store.ts, which reads the settings at module
// scope. What keeps the app booting would then be the order of two import lines in a component.
